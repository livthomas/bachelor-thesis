...
jBPM Console use a lot of various panels all over the screen.
These panels often provides some basic functionality and thus cannot be ommited.
In the mobile version there is a need to create a new page for each panel.
