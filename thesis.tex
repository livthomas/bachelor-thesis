...
The second one can be used to get basic information about entities, domain objects, data, forms and tasks associated with a particular business process.
...
Identity provider from UberFire is used in order to get the name of the currently logged-in.
