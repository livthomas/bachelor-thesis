...
Nowadays, we can notice a rapid growth of the market with smart mobile devices like smartphones or tablets.
...
Their graphical user interface (GUI) is often optimized just for standard desktop environments and does not take into account a lower screen resolution that is typical for the mobile devices.
...
The goal of this thesis is to look through the problematics of developing applications for mobile devices, compare advantages and disadvantages of different approaches and find the optimal solution for the jBPM Console\footnotemark\footnotetext{jBPM Console is an open-source application for business process management.}.
The mobile version of this application has been proposed on the website of the JBoss community\footnotemark\footnotetext{\url{https://community.jboss.org/wiki/JbpmProjects}} as the further extension of the jBPM project.
The thesis includes analysis, design and implementation of the chosen solution which includes the creation of a mobile version of this application with predefined subset of its functions like starting new processes or user task management.
