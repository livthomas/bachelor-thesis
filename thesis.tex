...
The application is only described from the user's point of view.
...
These include smaller screen size, higher fineness of the display, absence of mouse and keyboard, presence of touch control and limited computation power \cite{wroblewski11}.
...
The source code of the application as well as the deployable WAR file are attached.
