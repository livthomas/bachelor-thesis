...
Native applications do not offer any advantages over the web ones.
...
The architecture is described both in written form and using diagrams from the Unified Modeling Language (UML).

\subsection{Use cases}
The basic use cases are mentioned in the thesis assignment.
According to it the application should provide the functionality to manipulate with process runtime and human tasks.
...
They may also list all running process instances and abort any of them.
