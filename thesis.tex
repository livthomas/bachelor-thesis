...
The application was originally developed in jbpm-mobile\footnotemark\footnotetext{\url{https://github.com/Salaboy/jbpm-mobile}} repository which belongs to one of the jBPM core developers, Mauricio Salatino.
