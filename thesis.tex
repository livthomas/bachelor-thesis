...
business process, jBPM, jBPM Console, mgwt, mobile application, mobile web
\end{ThesisKeyWords}
...
A process model is stored as an XML file which besides diagram description contains also other information about the process like its data, messages, task assignments etc. \cite{silver11}
